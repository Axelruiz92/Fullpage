const seccionesPagina = new fullpage('#fullpage', {                        //const: es una variable que sera igual a una nueva instancia de fullpage; a fullpage debemos darle dos valores como parametros
  //   :::::: Opciones Basicas
	// ──────────────────────────────────────────────────
    ...
    //   :::::: Barra de navegación
        ...
        anchors: ['inicio', 'productos', 'contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu. Aqui podemos agregar mas secciones
